...
/**
 * Loads a file from the <project-dir>/resources folder and stores it inside a FileDocument.
 */
public class FileDocumentFromFile extends CustomJavaAction<java.lang.Boolean>
{
	...
	public java.lang.Boolean executeAction() throws Exception
	{
		...
		// BEGIN USER CODE
		FileInputStream fis = new FileInputStream(new File(Core.getConfiguration().getResourcesPath() + File.separator + this.file));
		Core.storeFileDocumentContent(getContext(), fileDocument.getMendixObject(), this.file, fis);
		fis.close();
		return true;
		// END USER CODE
	}
